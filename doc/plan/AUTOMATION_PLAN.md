...
- [ ] Keep `skill_creation/` aligned with the canonical Skills catalog by following the [per-Skill cadence](#skill-authoring-and-derived-working-copies) without duplicating normative contracts. <!-- STEP7-1b6577edc2dc -->
...
- Author each canonical Skill through the [per-Skill cadence](#skill-authoring-and-derived-working-copies) (plan, <!-- STEP7-f3d8206fd88c -->
