...
[PLUGIN_CONTRACTS.md]. The canonical Change Model is defined in
...
The highest-bandwidth form here is a sample: an example input, a hand-written "good" output, or an existing spec doc. Much better than describing in prose. This document — and its sibling contract documents under `doc/contracts/` — is exactly this kind of input: a structured spec.
